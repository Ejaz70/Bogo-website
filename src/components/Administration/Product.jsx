// src/components/Administration/Products.jsx
...
const rows = new Array(25).fill(0).map((_, i) => ({
  id: i + 1,
  name: ["Hotel ibis", "foodika", "ice frensh", "pizza mega", "burger king", "boo print", "picine aquao", "klen club"][i % 8],
  tagline: "Category Name • Store name",
  category: ["hotels", "restaurants", "COUPON", "entertainment", "beauty"][i % 5],
  price: `${2000 + i * 3} $`,
  book: ["prebook", "featured", "normal"][i % 3],
  swing: ["with timing", "normal", "slot"][i % 3],
  visit: ["visit twice", "once", "steady"][i % 3],
  status: ["verified", "Banned"][i % 2],
  date: "12/7/2023 15:06:05 PM",
}));
