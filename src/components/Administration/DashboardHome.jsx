...
const Avatar = ({ url, alt }) => (
  <div className="h-10 w-10 rounded-full overflow-hidden border border-white/10 bg-white/10">
    {url ? (
      ...
      <div className="h-full w-full grid place-items-center text-lg text-white/80">
        🙂
      </div>
    )}
  </div>
...
const SalesLocations = () => {
  ...
  const Map = () => (
    <svg viewBox="0 0 800 400" className="w-full h-[320px]">
      <rect width="800" height="400" rx="16" fill="#262626" />
      <g fill="#3a3a3a" opacity="0.55">
      ...
      <g>
        <path
          d="M140 90 L270 95 L280 130 L285 145 L270 165 L245 160 L215 168 L190 175 L160 155 L135 125 Z"
          fill="#2563eb"
        />
        <g transform="translate(240,132)">
          <rect
            ...
            opacity="0.9"
          />
          <text x="0" y="-6" textAnchor="middle" fontSize="12" fill="white">
            United States
          </text>
        </g>
      </g>
      <path
        d="M235 230 L300 235 L312 270 L305 305 L285 322 L260 328 L238 322 L220 295 L215 260 Z"
        fill="#f59e0b"
      />
      <path
        d="M550 95 L625 100 L642 118 L638 148 L620 165 L595 170 L565 158 L545 132 L540 110 Z"
        fill="#10b981"
      />
      <path
        d="M480 118 L522 122 L528 138 L515 149 L490 152 L470 142 L465 125 Z"
        fill="#6d28d9"
      />
    </svg>
  );
          ...
          <div className="mt-4 space-y-3">
            {[
              ...
              >
                ...
                <span
                  className={`text-[12px] text-white/90 px-3 py-1 rounded-full ${s.color}`}
                >
                  {s.total}
                </span>
              </div>
  ...
  return (
    <div className="bg-[#222222] text-gray-100 min-h-screen px-3 md:px-4">
      <div className="mx-auto w-full max-w-[1100px] py-4">
        ...
        {/* ---------- New Customers + Transaction History (narrower left) ---------- */}
        ...
        {/* ---------- New merchants + Transaction History (narrower left) ---------- */}
        <div className="grid grid-cols-1 xl:grid-cols-[340px_1fr] 2xl:grid-cols-[360px_1fr] gap-6 mt-6">
          <div className="bg-[#1e1e1e] rounded-2xl p-5">
            <div className="flex items-center justify-between mb-3">
